...
export function SaleSection() {
  ...
  return (
    <section 
        className="text-white py-24 md:py-28 bg-cover bg-center relative"
    >
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          ...
          <div className="text-center md:text-left">
            ...
            <p className="mt-2 text-base md:text-xl">Discount auto-applied at checkout</p>
            {timerComponents.length > 0 && (
                <div className="flex justify-center md:justify-start gap-4 md:gap-8 mt-6 md:mt-8">
                    {timerComponents}
                </div>
            )}
            <div className="mt-8 flex justify-center md:justify-start gap-2 md:gap-4 flex-wrap">
              <Button asChild size="sm" variant="outline" className="bg-white border-white text-black hover:bg-gray-200 hover:border-gray-200 transition-colors rounded-md">
